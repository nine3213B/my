        ...
        * {
        ...
        a:hover {
            text-decoration: underline;
               ...
               /* --- 📱 手機版專用修正 (Mobile Responsive) --- */
        @media (max-width: 600px) {
            
            /* 1. 縮減手機版邊距：手機寸土寸金，不要留太多白邊 */
            body {
                padding: 10px; /* 從 20px 縮小到 10px */
            }
            
            .container {
                margin: 20px auto; /* 上下距離縮小 */
                width: 100%; /* 強制佔滿寬度 */
            }

            .card {
                padding: 20px; /* 卡片內部空間縮小，讓內容有更多位置 */
            }

            /* 2. 字體調整：避免標題在手機上太大而換行得很醜 */
            h1 { font-size: 1.8em; }
            h2 { font-size: 1.4em; }
        }
